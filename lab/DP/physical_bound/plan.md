...
主矩阵已完成 1000/1000 个唯一点，0 deadlock、0 非零退出。五种对称合成流量
中尚未观察到相对 PRIV 的饱和吞吐正收益；STARVE 普遍显著优于 RR，说明需求
感知授予有效，但当前二值饥饿判据与主动归还仍有优化空间。下一步用方向偏置和
周期反转流量隔离“共享容量收益”，并对归还阈值、滞回和目标侧需求感知做小规模
敏感性实验，再决定是否扩展完整矩阵。
