...
The mechanism is deliberately small --- one counter per dimension pair
and one admission inequality; no new arbiter, table, or pipeline stage.
The substance of the design lies in where the check sits
(\S\ref{sec:retry}) and in why the composition with the background
substrates stays deadlock-free (\S\ref{sec:safety}).
